...
WHERE {
 GRAPH ?l1 { ?j a [] }
 VALUES ?l1 { <http://opencaesar.io/tutorial/description/L1-end-to-end-lander-operation> <http://opencaesar.io/tutorial/description/L1-end-to-end-orbiter-operation>}
...
WHERE {
 GRAPH ?l2 { ?j a [] }
 VALUES ?l2 { <http://opencaesar.io/tutorial/description/L2-end-to-end-lander-operations> <http://opencaesar.io/tutorial/description/L2-end-to-end-orbiter-operations>}
 ?j a mission:Junction ;
    mission:joins1 [
      a mission:Interface ;
      base:hasIdentifier ?i1_id
...
g2 <- graph_from_edgelist(as.matrix(df2))
...
```{r}
library(igraph, warn.conflicts = FALSE)
g3 <- graph_from_edgelist(as.matrix(df3))
